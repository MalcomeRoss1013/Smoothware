    ...
    render() {
        ...
        return (
                 ...
                 <div className="container-fluid float:left">
                        <Navbar.Brand href="/"> Smootheware</Navbar.Brand>
                        ...
                        <Navbar.Collapse id="navbarScroll">
                            ...
                            >
                                ...
                                <NavDropdown title="Officeware" id="basic-nav-dropdown">
                                    <NavDropdown.Item href="/OM">Organization and Management</NavDropdown.Item>
                                ...
                                <NavDropdown title="Operating Systems" id="basic-nav-dropdown">
                                ...
                                <NavDropdown title="Entertainment" id="basic-nav-dropdown">
                                    ...
                                    <NavDropdown.Item href="/videoplayer">Video Players</NavDropdown.Item>
                                </NavDropdown>
                                <Nav.Link  as={Link} to="/Antivirus">Antivirus</Nav.Link>
